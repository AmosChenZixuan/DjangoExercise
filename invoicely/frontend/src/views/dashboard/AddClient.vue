        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-6">
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="name" class="input" v-model="client.name" required>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="email" name="email" class="input" v-model="client.email" required>
                    </div>
                </div>
        ...
        submitForm(){
            axios.
                ...
                .catch(error => {
                    ...
                    toast({
                        message: 'The client was not added',
                        type: 'is-danger',
                        dismissible: true,
                        pauseOnHover: true,
                        duration: 2000,
